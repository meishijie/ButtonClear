...
class HXCPP_CLASS_ATTRIBUTES  FlxG_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::_v2::text::TextField addChildBelowMouse_openfl__v2_text_TextField( ::openfl::_v2::text::TextField Child,hx::Null< int >  IndexModifier);
		static Dynamic addChildBelowMouse_openfl__v2_text_TextField_dyn();
		...
		static ::flixel::input::android::FlxAndroidKeys android;
		...
		static ::flixel::system::scaleModes::BaseScaleMode _scaleMode;
