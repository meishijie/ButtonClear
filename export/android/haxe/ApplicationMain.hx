...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "FlxCamera", "com.example.myapp", "0.0.1");
		...
		flash.Lib.create (function () {
			...
			(4 == 4 ? flash.Lib.HW_AA_HIRES : 0) |
			(4 == 2 ? flash.Lib.HW_AA : 0),
			"FlxCamera",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "FlxCamera", null, { width: 0, height: 0 });
